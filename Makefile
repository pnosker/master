...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun May 11 21:41:37 2014
# Project:  vericoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile vericoin-qt.pro
#############################################################################
...
Makefile: vericoin-qt.pro  ../../../../Qt/4.8.5/mkspecs/default/qmake.conf ../../../../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile vericoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Users/Douglas/Dropbox/vericoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Users/Douglas/Dropbox/vericoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Users/Douglas/Dropbox/vericoin/src/leveldb/libleveldb.a: FORCE
